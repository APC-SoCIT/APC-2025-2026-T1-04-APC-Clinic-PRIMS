...
<head>
    ...
    <title>{{ $record->appointment->patient->first_name }} {{ $record->appointment->patient->last_name }} - {{ ucfirst($type) }} Record Request</title>
</head>
                    ...
                    <tr>
                        <td style="padding:30px; color:#333;">
                            ...
                            <div style="background-color:#f1f7ff; padding:15px; border-radius:8px; margin:15px 0; font-size:15px;">
                                <a href="{{ $url }}" style="display:inline-block;padding:10px 14px;background:#1f3a93;color:#fff;border-radius:6px;text-decoration:none;">
                                View {{ ucfirst($type) }} Record
                                </a>
                            </div>
